...
/**
 * SignIn Page - User authentication page
...
const SignIn = () => {
    ...
    const handleSubmit = (e) => {
        ...
        // For now, redirect to dashboard after "successful" sign in
    ...
    return (
        <AuthLayout>
            <div className='text-center mb-8'>
                ...
                <p className='text-gray-600'>Sign in to your Jharkhand Darshan account</p>
            </div>
