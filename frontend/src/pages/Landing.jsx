...
/**
 * Landing Page - Main landing page with hero section
 * Simple and clean design with call-to-action button
 */
const Landing = () => {
    return (
            ...
            <div className='flex items-center justify-center min-h-[calc(100vh-4rem)] px-4'>
                <div className='text-center max-w-4xl mx-auto'>
                    ...
                    <p className='text-xl md:text-2xl text-gray-600 mb-8 max-w-2xl mx-auto'>
                        Discover the beauty and culture of Jharkhand through our interactive platform. 
                        Explore, learn, and connect with the heart of India.
                    </p>
